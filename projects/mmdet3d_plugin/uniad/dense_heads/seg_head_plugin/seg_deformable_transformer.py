...
# - Adapt to DMAD by splitting the forward function to encode and decode
...
class SegDeformableTransformer(Transformer):
    ...
    def init_layers(self):
        ...
        if self.as_two_stage:
            ...
            self.reference_points = nn.Linear(self.embed_dims, 4)
    ...
    def encode(self,
        ...
        return (query, query_pos, memory, lvl_pos_embed_flatten, mask_flatten, reference_points, spatial_shapes,
    ...
    def decode(self,
        ...
        inter_states, inter_references = self.decoder(
            ...
            **kwargs)
        return query, memory, query_pos, inter_states, inter_references
    ...
    def forward(self,
        ...
        """
        # encode
        (query, query_pos, memory, lvl_pos_embed_flatten, mask_flatten, reference_points, spatial_shapes,
         level_start_index, valid_ratios, init_reference_out, enc_outputs_class, enc_outputs_coord_unact) = self.encode(
            mlvl_feats, mlvl_masks, query_embed, mlvl_pos_embeds)

        # decode
        query, memory, query_pos, inter_states, inter_references_out = self.decode(
            query, query_pos, memory, mask_flatten, reference_points,
            spatial_shapes, level_start_index, valid_ratios, reg_branches)
