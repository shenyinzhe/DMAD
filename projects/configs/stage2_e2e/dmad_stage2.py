...
#
# Modified by Yinzhe Shen on 2025-04-01:
# - Adapt to DMAD
# - Use queue_length = 3
# - Use fut_steps = 8
# - Enable loss_past_traj_weight since it's used for velocity learning
# - Use 4 gpus by default
...
planning_evaluation_strategy = "stp3"  # uniad or stp3
    ...
    pts_bbox_head=dict(
        ...
        track_config=dict(
            ...
            transformer=dict(
                ...
                decoder=dict(
                    type="DetectionTransformerDecoderJoint",
                    num_layers=6,
        ...
        map_config=dict(
            ...
            transformer=dict(
                ...
                decoder=dict(
                    type="DeformableDetrTransformerDecoderJoint",
                    num_layers=6,
                    return_intermediate=True,
                    transformerlayers=dict(
                        type="DetrTransformerDecoderLayer",
...
load_from = "ckpts/dmad_stage1.pth"
resume_from = "work_dirs/dmad_stage2/latest.pth"
